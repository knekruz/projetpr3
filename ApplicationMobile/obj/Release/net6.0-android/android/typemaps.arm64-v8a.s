...
map_modules:
	...
	.byte	0x2f, 0xbb, 0x20, 0x54, 0x45, 0x9, 0x1a, 0x41, 0xbc, 0xd9, 0x88, 0xe2, 0x11, 0x58, 0xee, 0x6	// module_uuid: 5420bb2f-0945-411a-bcd9-88e21158ee06
	...
	.byte	0x45, 0x13, 0xe7, 0x2, 0x4, 0xa0, 0xc1, 0x49, 0xad, 0x52, 0x34, 0xb8, 0x2, 0xb1, 0x62, 0x6f	// module_uuid: 02e71345-a004-49c1-ad52-34b802b1626f
	.word	0x3	// entry_count
	.word	0x0	// duplicate_count
	...
	.xword	map_aname.10	// assembly_name: Xamarin.AndroidX.RecyclerView
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
	...
	.byte	0xa3, 0xb6, 0xb5, 0x21, 0x23, 0xb9, 0x2b, 0x43, 0x86, 0x77, 0xf9, 0x9d, 0x4c, 0xc3, 0x34, 0xd2	// module_uuid: 21b5b6a3-b923-432b-8677-f99d4cc334d2
	.word	0x2	// entry_count
	.word	0x0	// duplicate_count
	.xword	.L.module23_managed_to_java	// map
	.xword	0	// duplicate_map
	.xword	map_aname.23	// assembly_name: ApplicationMobile
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
...
map_java:
	...
	.word	0x200000d	// type_token_id
	.ascii	"crc64a118afd476c167f0/MainActivity"	// java_name
	.zero	69	// byteCount == 34; fixedWidth == 103; returned size == 103
	.zero	1

	.word	0x17	// module_index
	.word	0x200000e	// type_token_id
	.ascii	"crc64a118afd476c167f0/MainApplication"	// java_name
	.zero	66	// byteCount == 37; fixedWidth == 103; returned size == 103
	.zero	1
